...
local tbl = 
{
	...
	[4] = {
		...
		url = [[https://raw.githubusercontent.com/KaliMinion/Moogle-Stuff/master/Moogle TTS.lua]],
		version = "1.1.6",
		category = "Utility",
...
enabled=1]],
	...
	[5] = {
		...
		url = [[https://raw.githubusercontent.com/KaliMinion/Moogle-Stuff/master/Moogle FPS.lua]],
		version = "1.2.7",
		category = "Utility",
		stability = "Working",
...
enabled=1]]
	...
	[6] = {
		...
		url = [[https://raw.githubusercontent.com/KaliMinion/Moogle-Stuff/master/Moogle PushButton.lua]],
		version = "1.0.1",
		category = "Dev",
		stability = "Working",
...
enabled=1]]
	...
	[7] = {
		...
		url = [[https://raw.githubusercontent.com/KaliMinion/Moogle-Stuff/master/Moogle Tweaks.lua]],
		version = "1.0.1",
		category = "Utility",
		stability = "WiP but Working",
