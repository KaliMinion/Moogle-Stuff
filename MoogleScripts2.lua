local tbl =
{
	[1] = {
		...
		url = "TestFolder/Moogle%20Updater",
	...
	[4] = {
		...
		url = "TestFolder/Moogle%20Scripts/Main%20Window",
		category = "Utility",
	...
	[5] = {
		...
		url = "TestFolder/Moogle%20Scripts/Moogle%20FPS",
		category = "Utility",
		stability = "Working",
	...
	[6] = {
		...
		url = "TestFolder/Moogle%20Scripts/Moogle%20PushButton",
		category = "Dev",
		stability = "Working",
	...
	[7] = {
		...
		url = "TestFolder/Moogle%20Scripts/Moogle%20Tweaks",
		category = "Utility",
		stability = "WiP but Working",
	...
	[8] = {
		...
		url = "TestFolder/Moogle%20Scripts/Moogle%20MultiSession%20Manager",
		category = "Utility",
		stability = "Beta",
