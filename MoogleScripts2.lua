local MoogleScripts = {
	...
	[4] = {
		...
		status = [[open]],
		filepath = [[Moogle Scripts\Moogle TTS.lua]],
		table = [[return MoogleTTS]],
		url = [[TestFolder/Moogle Scripts/Main Window]],
		category = [[Utility]],
	...
	[6] = {
		...
		status = [[open]],
		filepath = [[Moogle Scripts\Moogle PushButton.lua]],
	...
	[7] = {
		name = [[Moogle Tweaks]],
		status = [[open]],
		filepath = [[Moogle Scripts\Moogle Tweaks.lua]],
		table = [[return MoogleTweaks]],
		url = [[TestFolder/Moogle Scripts/Moogle Tweaks]],
		category = [[Utility]],
		stability = [[WiP but Working]],
	...
	[8] = {
		...
		status = [[open]],
		filepath = [[Moogle Scripts\Moogle MultiSession Manager.lua]],
		table = [[return MoogleMultiSessionManager]],
		url = [[TestFolder/Moogle Scripts/Moogle MultiSession Manager]],
		category = [[Utility]],
		stability = [[Beta]],
